...
Problem5::Problem5(unsigned int numDigits) : numDigits(numDigits), largestPalindromeProduct(1)
{
}
...
bool Problem5::isPalindrome(long long n)
{
	if (n < 10) return true;
...
bool Problem5::isPalindrome(unsigned int digits[], unsigned int length)
{
...
long long Problem5::getLargestPalindromeProduct()
{
